...
class StartBlindTestView(discord.ui.View):
    ...
    async def start(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        view = BlindTestView(settings=self.settings, vc=vc, musics=music_list)
        await interaction.response.edit_message(embed=embed_answers(self.settings["answers"]), view=view)
